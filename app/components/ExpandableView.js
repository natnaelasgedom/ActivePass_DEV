    ...
    case "personal info":
      results = (
        <View>
          ...
          <View style={styles.textContainer}>
            <Text style={[styles.textLabel, styles.fontSizeAndWeight]}>
              Weight:
            </Text>
            <Text style={[styles.text, styles.fontSizeAndWeight]}>75 kg</Text>
          </View>
          <View style={styles.textContainer}>
            <Text style={styles.textLabel}>Address:</Text>
            <Text style={styles.text}>Bogstadveien 1, 0355 Oslo</Text>
          </View>
        </View>
      );
      break;
